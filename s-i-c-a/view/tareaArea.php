...
<?php
    ...
    $sql = mysqli_query($conexion, "SELECT id, nombreA FROM areas_cultivo");
?>
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Asignar | Tarea - Área</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                    <li class="breadcrumb-item active">Tarea - Área</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="Cultivos_id" id="Areas_cultivo_id">
                                        <?php
                                            while ($datos = mysqli_fetch_array($sql)){
                                        ?>
                                                <option value="<?php echo $datos['id']?>"><?php echo $datos['nombreA']?></option>
                                        <?php
                                            }
                                        ?>
                                    </select>
...
<script>
    $(document).ready(function (){
        let tabla = $("#tablaarticulos").DataTable({
            "ajax": {
                url: "dataTareaArea.php?accion=listar",
                dataSrc: ""
            },
            "columns": [
                {"data": "id"},
                {"data": "areas_cultivo_id"},
                {"data": "tareas_id"},
        ...
        function recuperarDatosFormulario() {
            let registro = {
                id: $('#Codigo').val(),
                areas_cultivo_id: $('#Areas_cultivo_id').val(),
        ...
        function agregarRegistro(registro) {
            $.ajax({
                type: 'POST',
                url: 'dataTareaArea.php?accion=agregar',
                data: registro,
        ...
        function recuperarRegistro(id) {
            $.ajax({
                type: 'GET',
                url: 'dataTareaArea.php?accion=consultar&codigo=' + id,
                data: '',
                success: function(datos) {
                    $('#Codigo').val(datos[0].id);
                    $('#Areas_cultivo_id').val(datos[0].areas_cultivo_id);
        ...
        function modificarRegistro(registro) {
            $.ajax({
                type: 'POST',
                url: 'dataTareaArea.php?accion=modificar&codigo=' + registro.id,
                data: registro,
                success: function(msg) {
                    tabla.ajax.reload();
                },
