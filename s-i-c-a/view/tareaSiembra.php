...
$sql = mysqli_query($conexion, "SELECT id, nombre FROM siembras");
?>
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Asignar | Tarea - Siembra</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                    <li class="breadcrumb-item active">Tarea - Siembra</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="Cultivos_id" id="Siembras_id">
                                        <?php
...
<script>
    $(document).ready(function (){
        let tabla = $("#tablaarticulos").DataTable({
            "ajax": {
                url: "dataTareaSiembra.php?accion=listar",
                dataSrc: ""
            },
            "columns": [
                {"data": "id"},
        ...
        function agregarRegistro(registro) {
            $.ajax({
                type: 'POST',
                url: 'dataTareaSiembra.php?accion=agregar',
                data: registro,
        ...
        function borrarRegistro(id) {
            $.ajax({
                type: 'GET',
                url: 'dataTareaSiembra.php?accion=borrar&codigo=' + id,
                data: '',
                success: function(msg) {
                    tabla.ajax.reload();
                },
        ...
        function recuperarRegistro(id) {
            $.ajax({
                type: 'GET',
                url: 'dataTareaSiembra.php?accion=consultar&codigo=' + id,
                data: '',
                success: function(datos) {
                    $('#Codigo').val(datos[0].id);
                    $('#Siembras_id').val(datos[0].siembras_id);
        ...
        function modificarRegistro(registro) {
            $.ajax({
                type: 'POST',
                url: 'dataTareaSiembra.php?accion=modificar&codigo=' + registro.id,
                data: registro,
                success: function(msg) {
                    tabla.ajax.reload();
                },
