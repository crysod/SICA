        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <button class="btn btn-sm btn-primary" id="BotonAgregar">Agregar producto</button>
                </div><!-- /FIN COL -->
            </div><!-- / FIN ROW -->
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" id="Referencia" class="form-control" placeholder="Ingrese el codigo del producto.">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <!--<label>Referencia:</label>-->
                                    <input type="text" id="Nombre" class="form-control" placeholder="Ingrese nombre del producto.">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <!--<label>Nombre:</label>-->
                                    <input type="text" id="Descripcion" class="form-control" placeholder="Ingrese descripcion del producto.">
                                </div>
                            </div>
...
<script>
    $(document).ready(function (){
        let tabla = $("#tablaarticulos").DataTable({
            "ajax": {
                url: "dataProductos.php?accion=listar",
                dataSrc: ""
            },
            "columns": [
                {"data": "id"},
        ...
        function agregarRegistro(registro) {
            $.ajax({
                type: 'POST',
                url: 'dataProductos.php?accion=agregar',
                data: registro,
        ...
        function borrarRegistro(id) {
            $.ajax({
                type: 'GET',
                url: 'dataProductos.php?accion=borrar&codigo=' + id,
                data: '',
                success: function(msg) {
                    tabla.ajax.reload();
                },
        ...
        function recuperarRegistro(id) {
            $.ajax({
                type: 'GET',
                url: 'dataProductos.php?accion=consultar&codigo=' + id,
                data: '',
                success: function(datos) {
                    $('#Codigo').val(datos[0].id);
                    $('#Referencia').val(datos[0].codigo);
        ...
        function modificarRegistro(registro) {
            $.ajax({
                type: 'POST',
                url: 'dataProductos.php?accion=modificar&codigo=' + registro.id,
                data: registro,
                success: function(msg) {
                    tabla.ajax.reload();
                },
