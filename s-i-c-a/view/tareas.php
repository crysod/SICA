        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <button class="btn btn-sm btn-primary" id="BotonAgregar">Agregar tarea</button>
                </div><!-- /FIN COL -->
            </div><!-- / FIN ROW -->
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" id="Referencia" class="form-control" placeholder="Ingrese el codigo de la tarea.">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <!--<label>Referencia:</label>-->
                                    <input type="text" id="Nombre" class="form-control" placeholder="Ingrese nombre de la tarea.">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <!--<label>Nombre:</label>-->
                                    <input type="text" id="Descripcion" class="form-control" placeholder="Ingrese descripcion de la tarea.">
                                </div>
                            </div>
...
<script>
    $(document).ready(function (){
        let tabla = $("#tablaarticulos").DataTable({
            "ajax": {
                url: "dataTarea.php?accion=listar",
                dataSrc: ""
            },
            "columns": [
                {"data": "id"},
        ...
        function agregarRegistro(registro) {
            $.ajax({
                type: 'POST',
                url: 'dataTarea.php?accion=agregar',
                data: registro,
        ...
        function borrarRegistro(id) {
            $.ajax({
                type: 'GET',
                url: 'dataTarea.php?accion=borrar&codigo=' + id,
                data: '',
                success: function(msg) {
                    tabla.ajax.reload();
                },
        ...
        function recuperarRegistro(id) {
            $.ajax({
                type: 'GET',
                url: 'dataTarea.php?accion=consultar&codigo=' + id,
                data: '',
        ...
        function modificarRegistro(registro) {
            $.ajax({
                type: 'POST',
                url: 'dataTarea.php?accion=modificar&codigo=' + registro.id,
                data: registro,
                success: function(msg) {
                    tabla.ajax.reload();
                },
