...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Tareas | Siembra</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<script>
    $(document).ready(function (){
        let tabla = $("#tablaarticulos").DataTable({
            "ajax": {
                url: "dataSiembra.php?accion=listar",
                dataSrc: ""
            },
            "columns": [
                {"data": "id"},
        ...
        function agregarRegistro(registro) {
            $.ajax({
                type: 'POST',
                url: 'dataSiembra.php?accion=agregar',
                data: registro,
        ...
        function borrarRegistro(id) {
            $.ajax({
                type: 'GET',
                url: 'dataSiembra.php?accion=borrar&codigo=' + id,
                data: '',
                success: function(msg) {
                    tabla.ajax.reload();
                },
        ...
        function recuperarRegistro(id) {
            $.ajax({
                type: 'GET',
                url: 'dataSiembra.php?accion=consultar&codigo=' + id,
                data: '',
        ...
        function modificarRegistro(registro) {
            $.ajax({
                type: 'POST',
                url: 'dataSiembra.php?accion=modificar&codigo=' + registro.id,
                data: registro,
                success: function(msg) {
                    tabla.ajax.reload();
                },
